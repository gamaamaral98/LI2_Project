...
// #define HIPER_LINK  printf("<square x=%d y=%d width=%d height=%d xlink:href=%s%s%s />\n", x*SCALE, y*SCALE, SCALE, SCALE,)
...
/**
\brief Macro que imprime uma saída no mapa.
*/
...
/**
* Macro utilizada para o score board, top scores.
*/
#define TOP         9
